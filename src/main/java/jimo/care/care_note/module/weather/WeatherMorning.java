 ...
 */
@Component
public class WeatherMorning extends SendPhone implements SendMessage {
    @Resource
    APIUtil apiUtil;
    /***
    ...
    public String test(Map<Class, Object> map) {
        try {
            ...
            if (Objects.equals(module.getMorning(), auto)) {
            ...
            apiUtil.sendMail("1517962988@qq.com","Care_Note异常提醒",
                    "位置在jimo.care.care_note.module.weather中WeatherMorning，异常try-catch信息,测试阶段临时使用！！！" +
