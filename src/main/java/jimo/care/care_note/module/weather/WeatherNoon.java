 ...
 */
@Component
public class WeatherNoon implements SendMessage {
    ...
    public String test(Map<Class, Object> map) {
        ...
        module.setNoon(Objects.equals(module.getNoon(), auto) ? weatherIndex.getDetail() : module.getNoon());
        ...
        sendPhone.setM4(module.getNoon());
